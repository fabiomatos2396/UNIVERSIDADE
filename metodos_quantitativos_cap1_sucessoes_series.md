[01SlidesCap1_MQ25_26_Suc+Series_4Pf (1).md](https://github.com/user-attachments/files/28671651/01SlidesCap1_MQ25_26_Suc%2BSeries_4Pf.1.md)
...
## Soma dos $\mathbf{n} 1^{\text {os }}$ termos de uma progressão geométrica ( $a_{n}$ )
