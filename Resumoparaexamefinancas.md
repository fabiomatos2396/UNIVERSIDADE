...
| Dimensão | Sigla | Exemplos |
| :--- | :--- | :--- |
| Ambiental | E | Emissões de carbono, eficiência energética, biodiversidade, resíduos |
| Social | S | Direitos humanos, condições de trabalho, inclusão, comunidades |
| Governação | G | Ética empresarial, transparência, independência dos conselhos, anticorrupção |
...
### 4.1 Instrumentos de Dívida Titulada
...
### 4.2 Financiamento Bancário e Empréstimos
...
### 4.3 Produtos de Investimento e Finanças de Impacto
...
## 5. Impacto no Valor das Empresas
...
## 6. Desafios e Barreiras à Implementação
...
## 7. Papel dos Reguladores e Perspetivas Futuras
...
## 4. A Função Financeira na Empresa

## 1. Enquadramento da Função Financeira
...
### 1.1 As Organizações e as Empresas
...
| Tipo | Descrição |
| :--- | :--- |
| Unidade de produção | Combina fatores económicos segundo uma ação planeada. |
| Unidade de decisão, planeamento e controlo | Prossegue metas e fins implícitos com formulação de objetivos e programação. |
| Unidade financeira | Implica propriedade de meios de produção (capital) e relação com o meio envolvente. |
| Organização | Implica relações formais/informais, motivações, conflitos de interesses e superioridade do interesse da organização. |

### 1.2 Objetivos Gerais das Empresas
...
### 1.3 Sustentabilidade e Valor da Empresa
...
## O valor da empresa é influenciado por:
...
### 1.4 Gestão Financeira vs. Análise Financeira
...
## As decisões de gestão financeira devem:
...
## 2. Decisões Financeiras (4.2)

## As decisões financeiras nas empresas dividem-se em dois grandes grupos:

| Prazo | Tipo | Instrumentos |
| :--- | :--- | :--- |
| Médio/Longo prazo | Decisões de investimento Decisões de financiamento Distribuição de resultados | Estratégia financeira Orçamento financeiro Políticas de investimento, financiamento e dividendos |
| Curto prazo | Decisões operacionais (ativos e passivos correntes) | Gestão de caixa, clientes, inventários, fornecedores Orçamento de tesouraria |

### 2.1 Decisões de Médio e Longo Prazo
...
### 2.3 Integração de Critérios ESG nas Decisões Financeiras
...
## 5. Decisões Financeiras de Curto Prazo

## Introdução: As Decisões Financeiras de Curto Prazo
...
## Ciclos Financeiros da Empresa

Os ciclos financeiros da empresa subdividem-se em três:

| Ciclo | Atividades | Traduz-se em... |
| :--- | :--- | :--- |
| Investimento | Análise e seleção de investimentos e desinvestimentos | Ativo não corrente |
| Exploração | Aprovisionamento, produção e comercialização | Necessidades cíclicas (clientes e stocks) e recursos cíclicos (fornecedores) |
| Financiamento | Obtenção de fundos adequados aos investimentos e às NFM | Operações de capital e operações de tesouraria |
...
### 5.1 Ciclo de Exploração e Ciclo de Caixa

## Ativos e Passivos Correntes

| Ativos Correntes | Passivos Correntes |
| :--- | :--- |
| Realizados/vendidos/consumidos no decurso do ciclo de exploração | Liquidados no decurso do ciclo de exploração |
| Detidos essencialmente para negociação | Detidos para financiar parte dos ativos de maior liquidez |
| Realizados em liquidez num período até 12 meses após o balanço | Vencem-se num período até 12 meses após o balanço |
| Incluem elementos de caixa ou equivalentes de caixa | Não dão direito incondicional de diferir a liquidação por 12 meses |
...
## Regras de Gestão do Ativo e Passivo Corrente
...
## Necessidades de Fundo de Maneio (NFM) — Working Capital
...
## Algumas rubricas de ativos e passivos correntes têm caráter de permanente renovação:
...
| :--- | :--- |
| Inventários | Fornecedores (m.p., mercadorias, FSE) |
| Clientes | Adiantamentos de clientes |
| Adiantamentos a fornecedores | Estado e outros entes públicos (a pagar) |
| Estado e outros entes públicos (a receber) | Outras contas a pagar (de exploração) |
| Outras contas a receber (de exploração) |  |
| Reserva mínima de disponibilidades |  |
...
## Fórmula do Ciclo de Caixa

## Ciclo de caixa $=\mathbf{D M I}+\mathbf{P M R}-\mathbf{P M P}$
...
| DMI (mercadorias) $\boldsymbol{=}$ (Inventários de mercadorias / Custo das mercadorias vendidas) $\boldsymbol{\times} \mathbf{3 6 0}$ |
| :--- |
| DMI (matérias primas) = (Inventários de matérias primas / Custo das matérias consumidas) × 360 |
| DMI (produtos em curso) = (Inventários de produtos em curso / Custo de produção) × $\mathbf{3 6 0}$ |
...
## Estratégias para Reduzir o Ciclo de Caixa
...
### 5.2 Gestão de Ativos Correntes
...
### 5.2.1 Gestão de Stocks de Inventários
...
## Fatores a ponderar nos stocks mínimos:
...
| Vantagens de manter stocks | Inconvenientes de manter stocks |
| :--- | :--- |
| Evitar ruturas na produção/vendas por incumprimento de fornecedores | Investimentos elevados e imobilização de capital |
| Garantir consumo constante ao longo do período | Deterioração dos produtos |
| Proteção contra contingências | Aumento do espaço e custos de armazenagem |
| Obtenção de descontos de quantidade ou redução de custos de encomenda | Efeitos negativos sobre a tesouraria e rendibilidade |

### 5.2.2 Gestão de Dívidas a Receber (Curto Prazo)
...
## Objetivos da gestão de dívidas a receber:
...
## Custos vs. Benefícios da concessão de crédito:
...
## Fatores a ponderar na concessão de crédito:
...
### 5.2.3 Gestão dos Meios Financeiros Líquidos
...
## Objetivos da gestão de meios financeiros líquidos:
...
## Gestão de excedentes e défices de tesouraria:
...
### 5.3 Gestão de Passivos Correntes

Centra-se na gestão das dívidas a pagar de curto prazo:
| Tipo | Descrição |
| :--- | :--- |
| Crédito de fornecedores | Dívidas decorrentes de créditos obtidos de fornecedores (m.p., mercadorias e FSE) |
| Dívidas ao Estado e EOEP | Montantes a pagar ao Estado decorrentes das obrigações fiscais |
| Financiamentos obtidos (curto prazo) | Fundos obtidos para financiar défices de tesouraria ou oportunidades de negócio |
...
## A gestão das contas de fornecedores é responsável por:
...
## Dívidas ao Estado e Outros Entes Públicos (EOEP)
...
## Fórmula do Valor Líquido do desconto de letras:
...
## Factoring (Cedência de Créditos)
...
| :--- | :--- |
| O factor NÃO assume o risco de incumprimento é o aderente que o suporta. | O factor ASSUME a cobertura do risco de incumprimento dos devedores. |
| Se tiver havido financiamento, os montantes antecipados são debitados na conta do aderente em caso de incumprimento. | Mesmo que o devedor não liquide na data de vencimento, o montante adiantado NÃO tem de ser devolvido. |
...
| Vantagens do Factoring | Inconvenientes do Factoring |
| :--- | :--- |
| Liberta a empresa da gestão de cobranças (reduz custos administrativos) | Pode ter custo elevado - comissões incidem sobre o valor das faturas |
| Proporciona recursos imediatos (recebimento quase à vista) | Adiantamentos com margem de segurança (10\%20\%) |
| Acesso a financiamento de natureza comercial, sem endividamento | Intromissão do factor entre a empresa e os seus clientes |
| Minimiza incobráveis | Possibilidade de perda de clientes pelo rigor das cobranças |

## Desconto de Pronto Pagamento (DPP) aos Clientes
...
## Fórmula da taxa de juro anual implícita no DPP:
...
| Vantagens do DPP | Inconvenientes do DPP |
| :--- | :--- |
| Negociação feita no mercado conhecido da empresa | A capacidade de financiamento está limitada ao montante dos créditos concedidos |
| Facilita o financiamento da empresa que concede o desconto | Pode não coincidir com as necessidades efetivas de recursos |
| Pode contribuir para a redução do risco de incumprimento |  |
